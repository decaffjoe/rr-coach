const Progressions = {
  Pullup: [
    {
      ...
      desc:
        "Elbows should stay straight.Your back will arch more as you get stronger.These should be performed with a pause at the top. Squeeze your shoulders, hold it for 3-5s then release into a dead hang under control.If you can't pull out of the dead hang at all, consider using bands or your feet to assist you until you gain the necessary strength",
    },
    {
      name: "Arch Hangs",
      url: "https://www.youtube.com/embed/C995b3KLXS4?start=7",
      desc:
        "Elbows should stay straight.Hold it for time/reps.Progress towards a 90 degree in your shoulder",
    },
    {
      name: "Pullup Negatives",
      url: "https://player.vimeo.com/video/76666801",
      desc:
        "Jump to the top of the pullup position, then slowly (as slowly as you can), lower yourself until your arms are straight.Build up to 10sec negatives!",
    },
    {
      name: "Pullups",
    ...
    },
    {
      ...
      url: "",
      desc:
        "Like the fourth exercise in this progression, except with extra weight!.Some ways to add weight:.Put a dumbbell between your feet.Cross your feet and put a dumbbell between your calves.Use a belt and chain and add weight plates.Use a backpack full of something heavy.Leverage by putting priority on one of your arms.Use a weighted vest",
    },
  ],
  Squat: [
    {
    ...
    },
    {
      ...
      desc:
        "Pretend the dumbbell doesn't exist.Remain in the split stance throughout the set.Unlike a lunge, you don't return to a feet-together stance",
    },
    {
      name: "Bulgarian Split Squat",
      url: "https://www.youtube.com/embed/kkdmHTASZg8?start=75",
      desc:
        "Pretend the barbell doesn't exist.You can progress this further by elevating both your legs",
    },
    {
  ...
  Dip: [
    {
      ...
      desc:
        "Work up to 3 sets of 1 minute holds for this progression.If you can't hold yourself up at all, consider using bands or your feet to assist you until you gain the necessary strength",
    },
    {
      name: "Negative Dips",
    ...
    },
    {
      ...
      url: "",
      desc:
        "See general form cues.You can do this progression in place of ring dips.We recommend to add weight to parallel bar dips first instead of rings dips",
    },
  ],
  Hinge: [
    {
      ...
      desc:
        "Stand up straight.Brace and squeeze your butt to flatten your low back (neutral spine to maybe slightly arched).Send your butt back and lean your torso forward to avoid falling over.You can place the hands on your chest and abdomen for feedback or let them hang by your sides.Note: The GIF is 'robotic' for demonstration purposes, your execution should be smooth",
    },
    {
      name: "Single Legged Deadlift",
      url: "https://www.youtube.com/embed/iDV8r5u6En0",
      desc:
        "Please ignore the barbell.If you lack the balance to perform these with a leg in the air, you can use an arm to brace yourself against a surface or you can straddle your legs to help with balance",
    },
    {
      name: "Banded Nordic Curl Negatives",
      url: "https://www.youtube.com/embed/HUXS3S2xSX4",
      desc:
        "Anchor your feet under something sturdy.You want to be anchored about a fist's distance away from your ankle.Squeeze your butt to keep your hips extended.Slowly lower your torso, avoiding piking at the hips.Do a little push-up when you reach the bottom to get back to the top and 'skip' the concentric",
    },
    {
      name: "Banded Nordic Curl",
      url: "https://www.youtube.com/embed/HUXS3S2xSX4",
      desc:
        "Anchor your feet under something sturdy.You want to be anchored about a fist's distance away from your ankle.Squeeze your butt to keep your hips extended.Slowly lower your torso, avoiding piking at the hips.Note: Repeat these two progressions with weaker bands until you can move on",
    },
    {
      name: "Nordic Curls",
      url: "https://www.youtube.com/embed/d8AAPcYxPo8",
      desc:
        "Anchor your feet under something sturdy.You want to be anchored about a fist's distance away from your ankle.Squeeze your butt to keep your hips extended.Slowly lower your torso, avoiding piking at the hips",
    },
  ],
  Row: [
    {
    ...
    },
    {
      ...
      desc:
        "It's okay to flare your elbows on this one.On a bar: take a wide grip (150% of shoulder width) and perform rows like this.On rings: while performing a row, bring out the elbows to the side up to a 90 degree angle",
    },
    {
  ...
  Pushup: [
    ...
    },
    {
      ...
      desc:
        "Put your hands close together so the thumbs and index fingers touch, then perform a pushup.If this is too difficult or feels uncomfortable, put your hands just a bit closer than in a normal pushup.Work on moving the hands closer together over time until you reach diamond pushups",
    },
    {
      name: "Pseudo Planche Pushups",
      url: "https://www.youtube.com/embed/Cdmg0CfMZeo",
      desc:
        "Putting your hands sideways, lean forward with a straight body until your shoulders are in front of your hands.Perform a pushup while maintaining forward lean.Protract the shoulderblades at the top.Increase forward lean to make more difficult.Decrease forward lean to make easier.You won't run out of resistance anytime soon if you keep increasing your forward lean",
    },
  ],
  AntiExtension: [
    {
      ...
      desc:
        "Work up to a 30s hold then move on to your ring rollouts.You're only doing the planks, don't do every drill in the video",
    },
    {
      name: "Ring Ab Rollouts",
      url: "https://www.youtube.com/embed/LBUfnmugKLw",
      desc:
        "Elbows should stay straight.Remain in a hollow body position (ribs down, butt tucked).Keep your hands as close as your overhead mobility will allow.Higher ring position will make this easier.Elevating the feet will make it harder",
    },
  ],
  AntiRotation: [
    {
